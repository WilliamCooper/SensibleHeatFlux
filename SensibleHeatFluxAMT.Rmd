...
acknowledgements: |
  ...
  (\citet{wood2011vamos},
  \citet{albrecht2019CSET}, \citet{mcfarquhar2021observations}) that used
...
of phase and amplitude was repeated  After recalculating $Q$ using 
Eq.\ \eqref{eq:DHterm}
and that prediction of $T_{r}(t)$, the results were fitted again
