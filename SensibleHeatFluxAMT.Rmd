...
integration of the differential equations (Eqs.\ \eqref{eq:Ts} and \eqref{eq:Tm}) applied to $Q$, by Fourier transforms using the transfer function, and by applying a digital filter designed from the transfer function. All produce almost equivalent results. 
