...
arH <- arH / narH
ar2H <- ar2H / narH
sdrH <- ifelse(ar2H > arH^2, sqrt(ar2H - arH^2), 0)
...
temperature. Then the amplification of signals by application of the transfer function restores
the fluctuations produced by dynamic heating, and those fluctuations
are then removed by subtracting the measured dynamic heating
...
to heated sensors, possibly indicating inadequate representation of
...
that correction should be filtered to match the response of the temperature
...
\item An algorithm was proposed for measurements of sensible-heat flux that consists of using the transfer
