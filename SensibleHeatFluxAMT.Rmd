...
availability:
  codedata: |
    ...
    A package named Ranadu [@ranadu2.7],
...
acknowledgements: |
  ...
  Data provided by NSF NCAR EOL under sponsorship of the National Science Foundation. https://data.eol.ucar.edu/. 
...
## These next three lines are left over from earlier testing:
...
<!-- ## Using VSpecC because it doesn't set scale_x; need  -->
<!-- ## to set it specially here: -->
